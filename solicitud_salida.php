...
function BuscarArticulo(dato){
	...
	let sucursal = document.getElementById("Dim<?php echo $DimSeries; ?>").value;
	...
	if(dato!=""){
		if((cardcode!="")&&(almacen!="")){
			remote=open(`buscar_articulo.php?concepto=${conceptoSalida}&serie=${serie}&sucursal=${sucursal}&dim1=${dim1}&dim2=${dim2}&dim3=${dim3}&dim4=${dim4}&dim5=${dim5}&towhscode=${almacenDestino}&prjcode=${proyecto}&dato=`+dato+'&cardcode='+cardcode+'&whscode='+almacen+'&doctype=<?php if ($edit == 0) {
				echo "7";
			} else {
				echo "8";
