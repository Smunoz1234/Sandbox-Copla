				...
				<div class="row">
					<div class="col-lg-12">
						<div class="ibox-content">
							...
							<form action="consultar_operaciones.php" method="get" id="formBuscar"
									...
									<div class="col-lg-3">
										<select name="NombreEmpleado" class="form-control select2" id="NombreEmpleado">
											...
											<?php while ($row_EmpleadoActividad = sqlsrv_fetch_array($SQL_EmpleadoActividad)) { ?>
												<option value="<?php echo $row_EmpleadoActividad['NombreEmpleado']; ?>" <?php if ((isset($_GET['NombreEmpleado'])) && (strcmp($row_EmpleadoActividad['NombreEmpleado'], $_GET['NombreEmpleado']) == 0)) {
													  echo "selected=\"selected\"";
								...
								<?php if ($sw == 1) { ?>
									<div class="form-group">
										<div class="col-lg-8">
											<a
												href="exportar_excel.php?exp=18&Cons=<?php echo base64_encode(implode(",", $Param)); ?>&sp=<?php echo base64_encode('usp_TraerConsultaOperaciones'); ?>">
											...
											while ($row = sql_fetch_array($SQL)) { ?>
												<tr id="tr_<?php echo $i; ?>" class="gradeX">
													...
													<td><a href="llamada_servicio.php?id=<?php echo base64_encode($row['ID_LlamadaServicio']); ?>&tl=1"
															target="_blank"><?php echo $row['ID_Llamada']; ?></a></td>
													<td>
													...
													<td>
														<?php echo $row['MetodoAplicaLlamadas']; ?>
													</td>
													<td>
													...
													} ?>><?php echo $row['DeEstadoLlamada']; ?></span></td>
													<td><span <?php if ($row['IdEstadoServicioLlamada'] == '0') {
														...
														echo "class='label label-danger'";
													} ?>><?php echo $row['EstadoServicioLlamada']; ?></span></td>
													<td>
														<?php echo ($row['FechaActividad'] != "") ? $row['FechaActividad']->format('Y-m-d H:i') : ""; ?>
													</td>
													<td>
														<?php echo ($row['FechaCronograma'] != "") ? $row['FechaCronograma']->format('Y-m-d') : ""; ?>
													</td>
													<td>
														...
														<?php while ($row_TipoEstadoServ = sqlsrv_fetch_array($SQL_TiposEstadoServ)) { ?>
															<?php if ($row['IdTipoEstadoActividad'] == $row_TipoEstadoServ['ID_TipoEstadoServicio']) { ?>
																<span class='label text-white'
																	style="background-color: <?php echo $row_TipoEstadoServ['ColorEstadoServicio']; ?>;"><?php echo $row['NombreEstadoActividad']; ?></span>
															<?php } ?>
														<?php } ?>
													</td>
