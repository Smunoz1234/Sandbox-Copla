			  ...
			  <form action="orden_venta.php" method="post" class="form-horizontal" enctype="multipart/form-data" id="CrearOrdenVenta">
				...
				<div class="form-group">
					<label class="col-xs-12">
						<h3 class="bg-success p-xs b-r-sm"><i class="fa fa-info-circle"></i> Datos de la Orden</h3>
					</label>
					...
					<div class="col-lg-4">
						<label class="control-label">Condición de pago <span class="text-danger">*</span></label>
					
						<select name="CondicionPago" class="form-control" id="CondicionPago" required <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
							echo "disabled";
						} ?>>
							<option value="">Seleccione...</option>
				...
				<div class="form-group">
					...
					<?php foreach ($array_Dimensiones as &$dim) { ?>
						<div class="col-lg-4">
							...
							<select name="<?php echo $dim['IdPortalOne'] ?>" id="<?php echo $dim['IdPortalOne'] ?>" class="form-control select2" required <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
									  echo "disabled";
								  } ?>>
								<option value="">Seleccione...</option>
			   ...
			   <form id="frm" action="" class="form-horizontal">
				...
				<div class="col-lg-8">
					<div class="form-group">
						...
						<div class="col-lg-5">
							<select name="EmpleadoVentas" class="form-control" id="EmpleadoVentas" form="CrearOrdenVenta" required <?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
								echo "disabled";
							} ?>>
