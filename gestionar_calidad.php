			...
			<div class="table-responsive">
                    ...
                    <?php while($row=sqlsrv_fetch_array($SQL)){ ?>
						 <tr class="gradeX">
							...
							<td><?php if($row['Archivo']!=""){?><a href="filedownload.php?file=<?php echo base64_encode($row['ID_Archivo']);?>" target="_blank" class="btn btn-link btn-xs"><i class="fa fa-download"></i> Descargar</a><?php if(PermitirFuncion(205)||ConsultarUsuarioCargue($row['ID_Archivo'])){?> - <a href="#" onClick="EliminarRegistro(<?php echo $row['ID_Archivo'];?>);" class="btn btn-link btn-xs"><i class="fa fa-eraser"></i> Eliminar</a><?php }}else{?><p class="text-muted">Ninguno</p><?php }?></td>
						</tr>
					<?php }?>
                    </tbody>
                    </table>
