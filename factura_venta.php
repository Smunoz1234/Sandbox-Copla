			...
			<div class="wrapper wrapper-content">
				...
				<div class="ibox-content">
						...
						<div class="col-lg-12">
							<form action="factura_venta.php" method="post" class="form-horizontal"
								...
								<div class="form-group">
									...
									<div class="col-lg-4">
										<label class="control-label">Condición de pago <span
												class="text-danger">*</span></label>

										<select name="CondicionPago" class="form-control" id="CondicionPago" required
											<?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
												echo "disabled";
											} ?>>
											<option value="">Seleccione...</option>
									...
									<?php foreach ($array_Dimensiones as &$dim) { ?>
										<div class="col-lg-4">
											...
											<select name="<?php echo $dim['IdPortalOne'] ?>"
												id="<?php echo $dim['IdPortalOne'] ?>" class="form-control select2" required
												<?php if (($edit == 1) && ($row['Cod_Estado'] == 'C')) {
													echo "disabled";
												} ?>>
												<option value="">Seleccione...</option>
					...
					<form id="frm" action="" class="form-horizontal">
						...
						<input type="hidden" form="CrearFacturaVenta" id="IdFacturaVenta" name="IdFacturaVenta" value="<?php if ($edit == 1) {
							echo base64_encode($row['ID_FacturaVenta']);
						} ?>" />
						<input type="hidden" form="CrearFacturaVenta" id="IdEvento" name="IdEvento" value="<?php if ($edit == 1) {
